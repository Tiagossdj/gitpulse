					...
					<AnimatePresence mode="wait">
							...
							>
								...
								>
									...
									>
										...
										<span className="mono text-primary">Real-time Analysis</span>
									</motion.div>
									...
									>
										...
										forks, pull requests, issues e contribuidores — com cache via
						...
						{parseError ? (
							...
							>
								...
								<p className="text-center text-sm text-amber-400">{parseError}</p>
							</motion.div>
						) : null}
